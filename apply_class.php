...
$('#publisher_no').click(function(event){
   
    jq_submit('do.php/film/addpublication','title,issue_edition,publication_date,description');
    return false;
  
});
$('#publisher_next').click(function(event){

   jq_confirm('do.php/film/publisher_verify','p_title,telephone,fax,email',event);
...
<div id="wizard">
  <div title=" Type of Classification " style="width:470px">
    <p> I would like to submit an application for classification of:</p>
    <div class="container">
      <div class="controls">
        <div>
         <input type='radio' name='class_type' id="general"  value='general' >Film</input>
          <p><i>Submission of Film for Classification Section 18(1) of the Film and Publication Act, 1996, as amended</i></p>
        </div>
        <div>
          <input type='radio' name='class_type'  id="exemption" value='exemption'>Exemption</input>
          <p><i>Classification of music dvd's, educational films, children's movies </i></p>
        </div>
        <div>
          <input type='radio' name='class_type'  id="publication" value='publication'>Publication</input>
  ...
  <div title="Classification of films" style="width:550px"> 
  ...
  <div  title="Submission of a Publication for Classification" style="width:463px">
    <p><strong>The Film amd Publication Board may refuse to process yor application if this form is not fully completed.</strong></p> 
    <div class="container" >
      <div class="labels">
        <div class="line" >Title: </div>
    ...
    <div class="nav" >
      <button wizard=back class="button-medium">Back</button>
      <button wizard=next  id=publication_submit class="button-medium">Next</button>
    </div>       	
  </div>
  
  <div title="Publisher" style="width:440px;height:220px">
    <p>Are you the publisher of this material?</p>
    <div style="margin-left: auto; margin-right: auto; width: 180px">
      <input type="button" class = "button-medium" value="Yes" steps=3 wizard=next>
      <input type="button" class = "button-medium" value="No" id="publisher_no" wizard=next  />
    </div>
    
    <input type="button" class = "button-medium" value="Back"  wizard=back>
  </div>

  <div title="Publisher Details" style="width:390px">
    <div class="labels"> 
    ...
    <div class="line"> 
      <input type="button" class = "button-medium" value="Back"  wizard=back>
      <input type="button" class = "button-medium" value="Next" steps=2 id="publisher_next" wizard=next />
    </div>
  </div>


  <div title="Notes" style="width:750px;">
    <ol>
      <li>Proof of your right to distribute and/or exhibit this film in South Africa, in the format submitted, must be attached to this form.</li>
      ...
      Where payment has been made by direct deposit into the account of the Board, proof of such deposit must be attached to this form.</li>
